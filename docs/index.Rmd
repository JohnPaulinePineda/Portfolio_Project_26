...
|
| **[A]** The Isolation Forest algorithm was implemented only for the <span style="color: #FF0000">PC5</span> and <span style="color: #FF0000">PC7</span> principal component descriptors using the <mark style="background-color: #CCECFF">**isotree**</mark> package.  
|
...
###  1.5.2. Isolation Forest with Split Selection Criterion (SCIFOREST)
|
...
criterion on the same variable or linear combination held constant at a value of 1.
|
