...
Plot_Space_Range(OD_IF_DevianceScores,
                 "Deviance Scores : Isolation Forest (IF)",
                 1.0)
...
Plot_Space_Range(OD_EIF_DevianceScores,
                 "Deviance Scores : Extended Isolation Forest (EIF)",
                 1.0)
...
Plot_Space_Range(OD_SCIFOREST_DevianceScores,
                 "Deviance Scores : Isolation Forest with Split Selection Criterion (SCIFOREST)",
                 1.0)
...
Plot_Space_Range(OD_FCF_DevianceScores,
                 "Deviance Scores : Fair-Cut Forest (FCF)",
                 1.0)
...
Plot_Space_Range(OD_DIF_DevianceScores,
                 "Deviance Scores : Density Isolation Forest (DIF)",
                 1.0)
...
Plot_Space_Range(OD_BIF_DevianceScores,
                 "Deviance Scores : Boxed Isolation Forest (BIF)",
                 1.0)
...
(OutlierDetectionPeformance_Summary_Plot <- dotplot(OutlierDetectionAlgorithm ~ OutlierDetectionMetrics,
                          ...
                          groups = Set,
                          main = "Outlier Detection Algorithm Performance Comparison",
                          ylab = "Algorithm",
                          xlab = "Outlier Detection Performance Metrics",
                          auto.key = list(adj = 1),
                          type=c("p", "h"),
                          origin = 0,
                          alpha = 0.45,
